...
showPopup.addEventListener("click", function () {
	if (cardExpertise.style.opacity === "0" || cardExpertise.style.opacity === "") {
...
protectedLink.addEventListener("click", function(event) {
    const confirmation = confirm("To access this service, please sign up or log in. Do you want to proceed?");
...
const agileRules = [
    {
      pattern: /what is agile/i,
      response: "Agile is a project management and product development approach that prioritizes flexibility, collaboration, and customer feedback.",
    },
    {
      pattern: /key principles of agile/i,
      response: "Some key Agile principles include customer collaboration, responding to change, and delivering working software frequently.",
    },
    {
      pattern: /agile manifesto/i,
      response: "The Agile Manifesto is a set of guiding values and principles for Agile development, emphasizing individuals and interactions, working software, and customer collaboration.",
    },
    {
      pattern: /scrum framework/i,
      response: "Scrum is an Agile framework that involves fixed-length iterations called sprints, daily stand-up meetings, and a product backlog.",
    },
    {
      pattern: /kanban system/i,
      response: "Kanban is an Agile methodology focused on visualizing work, limiting work in progress, and optimizing flow.",
    },
    {
      pattern: /user story in agile/i,
      response: "A user story is a short, simple description of a feature or functionality from an end user's perspective.",
    },
    {
      pattern: /sprint in scrum/i,
      response: "A sprint in Scrum is a fixed time-boxed period (usually 2 to 4 weeks) during which a development team works to complete a set of user stories and produce a potentially shippable product increment.",
    },
    {
      pattern: /daily stand-up meeting/i,
      response: "A daily stand-up meeting is a short, daily team meeting in Agile where team members discuss their progress, plans, and any obstacles they're facing.",
    },
    {
      pattern: /product backlog/i,
      response: "A product backlog is a prioritized list of features, enhancements, and bug fixes that make up the work to be done on a product.",
    },
    {
      pattern: /sprint backlog/i,
      response: "A sprint backlog is a subset of items from the product backlog that a development team commits to completing during a sprint.",
    },
    {
      pattern: /changing requirements in agile/i,
      response: "Agile handles changing requirements by embracing change and allowing for flexibility in response to customer needs.",
    },
    {
        pattern: /tell me what Agilyst means/i,
        response: "Agilyst is a cutting-edge Agile project management platform designed to streamline your team's workflow.",
    },
    {
        pattern: /meaning of Agilyst/i,
        response:"The name Agilyst is a combination of Agile and Catalyst, two words that reflect our core values and vision. We are a team of experts who help organizations adopt agile practices and transform their culture and performance. We are catalysts for positive change and innovation, enabling our clients to achieve their goals faster and better.",
    },
    {
        pattern :/define Agilyst/i,
        response: "The name Agilyst is a combination of Agile and Catalyst, two words that reflect our core values and vision. We are a team of experts who help organizations adopt agile practices and transform their culture and performance. We are catalysts for positive change and innovation, enabling our clients to achieve their goals faster and better.",
...
function getBotResponse(userMessage) {
    ...
    // Provide a default response with friendlier suggestion links for other Agilyst-related questions
    const suggestionText = "Thanks for contacting Agilyst! 😊 To learn more about our platform, you can:\n";
    const suggestionLinks = {
      "Visit our website to learn more": "https://www.agilyst.com/about-us",
      "Explore our features": "https://www.agilyst.com/features",
      "Contact our support team": "https://www.agilyst.com/contact-us",
    ...
    const suggestions = Object.entries(suggestionLinks).map(([suggestion, link]) => `- [${suggestion}](${link})`);
    return suggestionText + suggestions.join("\n") + "\nFeel free to explore and reach out if you have more questions!";
  }
